...
var utils = (function () {
	...
	var _vendor = (function () {
		var vendors = ['webkitT', 't', 'MozT', 'msT', 'OT'],
			transform,
			i = 0,
			l = vendors.length;
...
/* REPLACE END: refresh */
		...
		if ( !this.hasVerticalScroll ) {
			this.hasVerticalScroll = this.options.scrollY; // zhanghuihua 不管页面数据多少都支持下拉刷新滚动
			this.maxScrollY = 0;
...
// INSERT POINT: _refresh
	...
	_transitionTime: function (time) {
		...
		//if ( !time && utils.isBadAndroid ) { // zhanghuihua 优化android性能注释掉
